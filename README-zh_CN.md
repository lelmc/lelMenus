...
| 类型   | 说明         | 示例 |
|------|------------|------|
| `>`  | 大   于      | `input="<player_level>", output="10"` |
| `>=` | 大于等于       | `input="<player_exp_total>", output="100"` |
| `<`  | 小于         | `input="<player_health>", output="5"` |
| `<=` | 小于等于       | `input="<player_food>", output="20"` |
| `==` | 等于         | `input="<player_level>", output="50"` |
